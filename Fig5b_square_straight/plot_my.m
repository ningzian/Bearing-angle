...
% to see simulation results shown in the paper Fig 5b, 
% please change the data file to "data_Fig5b.mat"
load('data.mat')   % "data_Fig5b.mat"
speed = 1;         % plot speed 
...
rectan_points_y = [-sqrt(2)/4, sqrt(2)/4, sqrt(2)/4, -sqrt(2)/4];  % 正方形目标
...
axis(ax_dis, [0, (total_t)*dt, 0, y_max]);
...
axis(ax_l, [0, (total_t)*dt, 0, y_max*1.2]);
